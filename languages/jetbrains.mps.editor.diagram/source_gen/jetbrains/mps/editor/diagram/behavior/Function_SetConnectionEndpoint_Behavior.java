...
public class Function_SetConnectionEndpoint_Behavior {
  public static void init(SNode thisNode) {
  }

  public static List<SNode> virtual_getParameters_1213877374450(SNode thisNode) {
    return ListSequence.fromListAndArray(new ArrayList<SNode>(), SConceptOperations.findConceptDeclaration("jetbrains.mps.editor.diagram.structure.Parameter_Node"), SConceptOperations.findConceptDeclaration("jetbrains.mps.editor.diagram.structure.Parameter_TargetNode"), SConceptOperations.findConceptDeclaration("jetbrains.mps.editor.diagram.structure.Parameter_Port"));
  }
}
